"""
@file
@brief Various functions to install `Miktex <http://miktex.org/>`_.
"""
...
def install_miktex(dest_folder=".", fLOG=print, install=True, version=None):
    """
    install `MikTex <http://miktex.org/>`_ (only on Windows)
