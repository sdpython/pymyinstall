...
regex_wheel_version0 = "[-](triangle[-]([0-9]{8}))[-]"
...
# pylzma-0.4.9.4.dev0-cp37-cp37m-win_amd64.whl
regex_wheel_version7 = "[-](([0-9]+[.][0-9]+[.][0-9]+[.][0-9]+)[.]dev0)[-]"

regex_wheel_versions = [
    regex_wheel_version0,
    regex_wheel_version,
