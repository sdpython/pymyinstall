...
#define MyAppURLCB "http://lesenfantcodaient.fr/"
...
; IPython
Name: "{app}\IPython Console"; IconFilename: "{app}\tools\icons\ipython.ico"; Filename: "{app}\python\Scripts\ipython.exe"; IconIndex: 0; WorkingDir: "{app}\workspace"
Name: "{app}\IPython Qt Console"; IconFilename: "{app}\tools\icons\ipython.ico"; Filename: "{app}\python\Scripts\ipython.exe"; IconIndex: 0; WorkingDir: "{app}\workspace"; Parameters: "qtconsole --pylab=inline"
Name: "{app}\IPython Notebook"; IconFilename: "{app}\tools\icons\jupyter.ico"; Filename: "{app}\python\Scripts\ipython.exe"; IconIndex: 0; WorkingDir: "{app}\workspace"; Parameters: "notebook --notebook-dir={app}\workspace --pylab=inline"
; python
Name: "{app}\Python Console"; IconFilename: "{app}\tools\icons\python.ico"; Filename: "{app}\python\python.exe"; IconIndex: 0; WorkingDir: "{app}\workspace"
Name: "{app}\Rodeo"; IconFilename: "{app}\tools\icons\yhat.ico"; Filename: "{app}\python\Scripts\rodeo.exe"; IconIndex: 0; WorkingDir: "{app}\python"; Parameters: "{app}\workspace"
Name: "{app}\Spyder"; IconFilename: "{app}\tools\icons\spyder.ico"; Filename: "{app}\python\Scripts\spyder.bat"; IconIndex: 0; WorkingDir: "{app}\python"; Parameters: "{app}\workspace"
