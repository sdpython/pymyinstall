...
.. blogpost::
    ...
    `pythonnet-2.1.1-cp35-none-win_amd64.whl <http://www.xavierdupre.fr/enseignement/setup/pythonnet-2.1.1-cp35-none-win_amd64.whl>`_.
    ...
    many prints to understand where the module was stuck::
        ...
        D:\python_source\Python-3.5.1\PCbuild\amd64\python -c "import clr;print(clr.__dict__)"
