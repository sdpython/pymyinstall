...
.. blogpost::
    ...
    ::
        ...
        pip3.7 install xlwt xlrd wikipedia pycurl xlsxwriter pyinstrument wptools flask dask bcolz pygame
    ...
    ::
        ...
        pip3.7 install pyspark qgrid yahoo_historical py4j
        pip3.7 install version_information xgboost natsort pivottablejs
        pip3.7 install colormap easydev dbfread quandl seaborn requests-file requests-ftp lxml opencv-python
