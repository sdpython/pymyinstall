...
.. blogpost::
    ...
    **Firewall**
    ...
    ::
        ...
        apt-get protobuf-compiler libprotoc-dev
        apt-get chromium-driver
    ...
    **Python**
    ...
    ::
        ./configure --enable-optimizations --with-ensurepip=install
        make altinstall --enable-shared --prefix=/opt/bin
    
    These settings must be added every time a python module is compiled:
    
    ::
    
        export LD_LIBRARY_PATH=/opt/bin
        export PATH=/usr/local/Python-3.9.1:$PATH
